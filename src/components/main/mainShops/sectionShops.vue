<template>
  <div class="w-[1360px] bg-[#FFFFFF] my-4 mx-auto rounded-[10px] pb-[63px]">
    <div class="flex items-end justify-between">
      ...
      <div>
        <div
            class="flex mt-[48px] ml-[64px] bg-[#FAFAFA] w-[832px] rounded-[10px] p-4"
            v-for="(product, index) in products"
            :key="index"
        >
          <img src="../../../assets/phone.png" alt="product" />
          <div class="ml-5">
            <p class="mt-[35px] ml-[70px] text-[13px] text-[#666666]">({{ product.stock }})</p>
            <h3 class="font-bold text-[14px] text-[#000000] mt-2">
              {{ product.name }}
            </h3>
            <p class="font-semibold text-[18px] text-[#F1352B] mt-4">
      ...
      <div class="border border-[#1ABA1A] rounded-[10px] mb-[-15px] mr-[48px]">
        <div class="p-[31px]">
          ...
          <div class="flex w-[339px] items-center justify-between">
            <p class="my-[15px] text-[14px] text-[#666666]">Shipping estimate:</p>
          ...
          <button class="bg-[#1ABA1A] rounded-[10px] py-[16px] px-[43px] font-[medium] text-[12px] uppercase text-[#FFFFFF] mt-[31px] ml-[93px]">
            checkout
          </button>
        </div>
      </div>
