<template>
  <div class="mt-[28px] mx-[30px] pb-[23px] flex justify-between">
    ...
    <div class="flex">
      ...
      <div class="mr-6">
        <p class="text-[11px] uppercase text-[#666666]">welcome</p>
        <p class="font-bold uppercase text-[14px] text-[#000000]">log in / Register</p>
      </div>
      <div class="flex gap-4">
        <div class="w-10 h-10 rounded-[20px] bg-[#EBEEF6] relative">
          <div class="bg-[#1ABA1A] absolute h-5 w-5 rounded-[10px] bottom-[-5px] right-[-5px]">
            <p class="text-[#FFFFFF] ml-[7px] mt-[1px] text-[11px]">5</p>
          </div>
        </div>
        <div>
          <p class="text-[11px] uppercase text-[#666666]">cart</p>
          <p class="font-bold uppercase text-[14px] text-[#000000]">$1,689.00</p>
        </div>
      </div>
    </div>
  </div>
